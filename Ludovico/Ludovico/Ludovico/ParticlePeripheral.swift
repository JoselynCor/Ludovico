...
class ParticlePeripheral: NSObject {
    ...
    public static let services2UUID        = CBUUID.init(string: "FFE0")
    public static let temperaturaCharacteristicUUID         = CBUUID.init(string: "E0270E9C-DCF9-470B-FFBF-579AF1BE1BE6")
